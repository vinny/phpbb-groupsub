...
$lang = array_merge($lang, array(
	...
	'ACP_GROUPSUB_WEBHOOK_ID'				=> 'Webhook ID',
	'ACP_GROUPSUB_WEBHOOK_ID_EXPLAIN'		=> 'Required for auto-renewing subscriptions and real-time payment updates.',
	...
	'ACP_GROUPSUB_WEBHOOK_GUIDE_TITLE'		=> 'Setting up PayPal Webhooks',
	'ACP_GROUPSUB_WEBHOOK_GUIDE_EXPLAIN'	=> 'Webhooks allow PayPal to notify your forum when a recurring subscription renews, cancels, or expires. To configure a webhook, open your application in the <a href="https://developer.paypal.com/developer/applications/" target="_blank">PayPal Developer Dashboard</a>, scroll down to <strong>Webhooks</strong>, click <strong>Add Webhook</strong>, paste the URL below, and subscribe to the listed event types.',
	'ACP_GROUPSUB_WEBHOOK_URL'				=> 'Webhook URL',
	'ACP_GROUPSUB_WEBHOOK_EVENTS_TITLE'		=> 'Required Webhook event subscriptions',
	'ACP_GROUPSUB_EVENT_PAYMENT_SALE_COMPLETED'		=> 'Payment sale completed',
	'ACP_GROUPSUB_EVENT_BILLING_SUBSCRIPTION'		=> 'Billing subscription',
	'ACP_GROUPSUB_EVENT_BILLING_SUB_ACTIVATED'		=> 'Billing subscription activated',
	'ACP_GROUPSUB_EVENT_BILLING_SUB_CANCELLED'		=> 'Billing subscription cancelled',
	'ACP_GROUPSUB_EVENT_BILLING_SUB_CREATED'		=> 'Billing subscription created',
	'ACP_GROUPSUB_EVENT_BILLING_SUB_EXPIRED'		=> 'Billing subscription expired',
	'ACP_GROUPSUB_EVENT_BILLING_SUB_PAYMENT_FAILED'	=> 'Billing subscription payment failed',
	'ACP_GROUPSUB_EVENT_BILLING_SUB_RE_ACTIVATED'	=> 'Billing subscription re-activated',
	'ACP_GROUPSUB_EVENT_BILLING_SUB_SUSPENDED'		=> 'Billing subscription suspended',
	'ACP_GROUPSUB_EVENT_BILLING_SUB_UPDATED'		=> 'Billing subscription updated',
